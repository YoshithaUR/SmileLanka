...
const MountainAdventures = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white">
      ...
      {/* Hero Section */}
      <section id="hero" className="relative h-[500px] md:h-screen flex items-center justify-center overflow-hidden pt-0">
        <div 
        ...
        <div className="absolute bottom-6 md:bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
          <svg className="w-6 h-6 md:w-8 md:h-8 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
